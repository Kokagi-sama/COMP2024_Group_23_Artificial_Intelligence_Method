...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Array List of Array List of soltions for storing generated final solutions per iteration of the algorithm
            ...
            // Array List of Array List of soltions for storing generated final solutions per iteration of the algorithm
            best_final_solutions_per_algorithm_iteration.clear();

            for (int iteration = 1; iteration <= algorithm_iterations; iteration++) {

                // Creating Array List of generated final solutions
                ArrayList<Solution> best_final_solutions_genetic_algorithm = new ArrayList<Solution>();
                ...
                for (BinPackingProblem problem: problems) {
                    ...
                    best_final_solutions_genetic_algorithm.add(genetic_algorithm_solution.getBestSolution());
                }

                best_final_solutions_per_algorithm_iteration.add(best_final_solutions_genetic_algorithm);
            }

            // Creating and Saving Boxplot
            ChartUtilities.buildAndSaveBoxPlot(best_final_solutions_per_algorithm_iteration, "Genetic_Algorithm", result_output_directory, chart_width, chart_height);
            ...
            for (int iteration = 1; iteration <= algorithm_iterations; iteration++) {
                ...
                // Creating Array List of generated final solutions
                ArrayList<Solution> best_final_solutions_adaptive_fitness_dependent_optimizer = new ArrayList<Solution>();
                ...
                for (BinPackingProblem problem: problems) {
                    ...
                    best_final_solutions_adaptive_fitness_dependent_optimizer.add(adaptive_fitness_dependent_optimizer_solution.getBestSolution());
                }

                best_final_solutions_per_algorithm_iteration.add(best_final_solutions_adaptive_fitness_dependent_optimizer);

            }

            // Creating and Saving Boxplot
            ChartUtilities.buildAndSaveBoxPlot(best_final_solutions_per_algorithm_iteration, "Adaptive_Fitness_Dependent_Optimizer", result_output_directory, chart_width, chart_height);
            ...
            for (int iteration = 1; iteration <= algorithm_iterations; iteration++) {
                ...
                // Creating Array List of generated final solutions
                ArrayList<Solution> best_final_solutions_perturbation_minimum_bin_slack_solution = new ArrayList<Solution>();
                ...
                for (Solution solution: initial_solutions) {
                    ...
                    best_final_solutions_perturbation_minimum_bin_slack_solution.add(perturbation_minimum_bin_slack_solution.getBestSolution());
                }

                best_final_solutions_per_algorithm_iteration.add(best_final_solutions_perturbation_minimum_bin_slack_solution);

            }

            // Creating and Saving Boxplot
            ChartUtilities.buildAndSaveBoxPlot(best_final_solutions_per_algorithm_iteration, "Perturbation_Minimum_Bin_Slack", result_output_directory, chart_width, chart_height);
            ...
            System.out.println("Generating Ant Colony Optimization Solutions....");
            ...
            for (int iteration = 1; iteration <= algorithm_iterations; iteration++) {
                ...
                // Creating Array List of generated final solutions
                ArrayList<Solution> best_final_solutions_ant_colony_optimization = new ArrayList<Solution>();
                ...
                for (BinPackingProblem problem: problems) {
                    ...
                    best_final_solutions_ant_colony_optimization.add(ant_colony_optimization_solution.getBestSolution());
                }

                best_final_solutions_per_algorithm_iteration.add(best_final_solutions_ant_colony_optimization);

            }

            // Creating and Saving Boxplot
            ChartUtilities.buildAndSaveBoxPlot(best_final_solutions_per_algorithm_iteration, "Ant_Colony_Optimization", result_output_directory, chart_width, chart_height);
